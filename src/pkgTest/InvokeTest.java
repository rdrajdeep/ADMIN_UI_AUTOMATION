...
public class InvokeTest {
	...
	public void setup() throws IOException{
  	...
  	@Test(priority= 1, enabled=false)// Track & Trace setup module
   	...
   	@Test(priority=1,enabled=true) // Gen2 BK setup module
   	public void TC_gen2BKSetup() throws IOException, InterruptedException{
   		UIoperations objui=new UIoperations();
   		ExcelUtility.excelInstance().setExcelFile("Gen2Setup_test.xlsx", "Sheet1");
   		Login login=new Login();
   		String ediID="ASB";
   		String ftpID="avon8312";
    	...
    	String EmailAdd="SUPPORT-SEAFREIGHT-EDI.PAC@PANALPINA.COM, beatrice.macaj@panalpina.com, Jasstine.Ang@panalpina.com";
    	ArrayList<Double> array=ExcelUtility.excelInstance().Gen2Setup();
    	int size=array.size();
    	int company_id;
    	String companyidAsString=null;
    	...
    	for(int i=0;i<size;i++){
        	...
        	login.BKEmailSetupOB("Error",EmailAdd); 
