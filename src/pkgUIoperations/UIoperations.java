...
public  class UIoperations {
	...
	public void invokeClickByIndex(int IndexValue){
	    List<WebElement> elements = driver.findElements(By.xpath("//input[@id='addsubscription']"));           
        int indexSize=elements.size();
        //System.out.println("Size is: "+indexSize);
        WebElement ele=elements.get(IndexValue);
        ele.click();
	...
	public void ajaxCall(By locator, String input){
		...
		//ConfigureDriver.getInstance().explicitWait(10).until(ExpectedConditions.visibilityOfElementLocated(By.id("ajaxAuto_ediId")));    	
		element.sendKeys(Keys.ARROW_DOWN);
		element.sendKeys(Keys.RETURN);
	}

	public void dealy(int time){
