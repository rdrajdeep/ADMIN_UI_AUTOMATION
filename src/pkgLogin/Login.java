...
import pkgWebdriverUtility.WebDriverUtility;
    ...
    public void BKlinkSetupIB(String ediid,String ftpid, String mapName) throws InterruptedException{
    	...
    	objUI.invokeClickByIndex(0);
    	//Manipulate popup window
    
    	ConfigureDriver.getInstance().explicitWait(10).until(new ExpectedCondition<Boolean>() {
            @Override
    	...
    	// End of manipulate pop up window.
//    	ConfigureDriver.getInstance().explicitWait(10);//.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("body > form > table > tbody > tr > td > table:nth-child(1) > tbody > tr > td.popup_title")));
//    	//Thread.sleep(2000);
//    	driver.getWindowHandles(); // This line of code is specially for IE browser
...
//           }
    ...
    public void BKEmailSetupOB(String notificationType, String emails) throws InterruptedException{
    	...
    	objUI.invokeClickByIndex(2);
//    	ConfigureDriver.getInstance().explicitWait(10);//.until(ExpectedConditions.visibilityOfElementLocated(LinkSubscriptionPage.select_EmailStatus));
//    	//Thread.sleep(2000);
//    	driver.getWindowHandles();
//    	Set<String> availableWindows=driver.getWindowHandles();
...
//    	
    	...
    	if(notificationType.equals("Success")){
    		...
    		//ConfigureDriver.getInstance().explicitWait(10);
    		objUI.dealy(20);
    		//Thread.sleep(2000);
    ...
    public void addTnT(String ediid,String ftpid) throws InterruptedException{
			...
			WebElement check=ConfigureDriver.getInstance().explicitWait(10).until(ExpectedConditions.visibilityOfElementLocated(CompanySummaryPage.addTnT));
			System.out.println("checkin message event element"+check.getText());
